...
\\
\\
\Rpackage{Pathview} ($\ge1.2.4$) work with all KEGG species (about 3000) plus KEGG Orthology (with \R{species="ko"}) (\hyperref[subsec:species]{Subsection \ref*{subsec:species}}).
\\
